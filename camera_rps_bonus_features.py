...
import time
'''
An implementation of the programme in `camera_rps.pt that additionally prints messages on the screen.`    
'''
class Game:
  def __init__(self):
    ...
    self.font = cv2.FONT_HERSHEY_SIMPLEX # font to be used in text messages
    self.intro_message = ""
